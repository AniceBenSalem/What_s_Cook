...
function partagerRecette(titre) {
	...
	var message = "<div class=\"row\"><br><div class=\"col-md-2 col-sm-3 text-center\"><a class=\"story-title\" href=\"#\"><img alt=\"\" src=\"http://api.randomuser.me/portraits/thumb/women/56.jpg\" style=\"width:100px;height:100px\" class=\"img-circle\"></a></div><div class=\"col-md-10 col-sm-9\"><h3>"+readCookie('login')+" vous propose cette recette : "+titre+"</h3> <div class=\"row\"><div class=\"col-xs-9\"><small style=\"font-family:courier,'new courier';\" class=\"text-muted\">Il y a quelques secondes • <small class=\"text-muted\">"+readCookie('login')+"</small></small></h4></div><div class=\"col-xs-3\"></div></div><br><br></div></div><hr>";
	$.ajax({
	    url:"http://localhost:8080/v1/post/ajouterPostRecette/"+login+"/"+message,
		type: "GET",
		datatype:'APPLICATION_JSON',
		success: function(json) {
		},
